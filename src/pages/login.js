            ...
            <Grid container className={classes.form} >
                ...
                <Grid item sm>
                    ...
                    <form noValidate onSubmit={this.handleSubmit}>
                        ...
                        <Button type="submit" variant="contained" color="primary" className={classes.loginButton} disabled={loading} >Login {loading && (
                            <CircularProgress size={22} className={classes.progress} />
                        )} </Button>

                        <small className={classes.signupText}> Dont have an account?  Sign Up <Link to="/signup" className={classes.signupLink}>HERE</Link></small>
                    </form>
                </Grid>
                <Grid item sm />
            </Grid>
